...
Escribe un programa en Python que calcule el `factorial <https://es.wikipedia.org/wiki/Factorial>`_ de un número.
...
.. table::
    ...
    +========+=========+================================================+
    | ``n``  | ``int`` | Número de entrada al que calcular el factorial |
    +--------+---------+------------------------------------------------+
...
.. table::
    ...
    |    Nombre     |  Tipo   |          Descripción           |
    +===============+=========+================================+
    | ``factorial`` | ``int`` | Factorial del número :math:`n` |
    +---------------+---------+--------------------------------+
